            ...
            <div className='container'>
                <div className='content'>
                    <div className='col-1'>
                        ...
                        <h1><span className='primary-color' style={{color: "rgb(208, 0, 0)"}}>online business</span></h1>
                        <p>
                        ...
                        <div className='form-layout'>
                            <div className='form-container'>
                                ...
                                <form action=''>
                                    ...
                                    <button style={{backgroundColor: "rgb(208, 0, 0)",border:"rgb(208, 0, 0)"}} >Create your account</button>
                                </form>
                            </div>
